...
using AbcBlog.Core.Events.RegisterSuccessed;
...
namespace AbcBlog.WebApp.Controllers
{
    public class AuthController : Controller
    {
        ...
        public AuthController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, IMediator mediator, IEmailSender emailSender, IOptions<SystemConfig> systemConfig)
        {
