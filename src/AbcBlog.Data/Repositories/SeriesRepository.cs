...
namespace AbcBlog.Data.Repositories
{
    public class SeriesRepository : RepositoryBase<Series, Guid>, ISeriesRepository
    {
        ...
        public SeriesRepository(AbcBlogContext context, IMapper mapper) : base(context)
        {
            _mapper = mapper;
        }
        ...
        public async Task AddPostToSeries(Guid seriesId, Guid postId, int sortOrder)
        {
            ...
            {
                var newPostInSeries = new PostInSeries
                {
                    PostId = postId,
                    SeriesId = seriesId,
                ...
                await _context.PostInSeries.AddAsync(newPostInSeries);
            }
        }
